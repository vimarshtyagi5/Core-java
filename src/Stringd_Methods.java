...
public class Stringd_Methods {
    ...
    public static void main(String[] args)
    {
      ...
      /*  What is the difference between str1 == str2 and str1.equals(str2)?
         ...
         and the .equals() method can be used to compare content. To put it simply,
          == checks if the objects point to the same memory location, whereas .equals()
       ...
       /* System.out.println("Enter the string for comparison");
        ...
        System.out.print("c".compareTo("b"));
        System.out.println();
