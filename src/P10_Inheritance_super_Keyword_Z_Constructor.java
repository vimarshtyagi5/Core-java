...
public class P10_Inheritance_super_Keyword_Z_Constructor {
    ...
    public static void main(String []args)
    {
       ...
       Second s=new Second(5);
		...
		/*for understanding the concept of super class, follow these steps:-
		...
		***  D:- Second s=new Second(5);
		    	 O/P:-In first Class integer    ## "deafult" constructor of superclass will get printed in every condition
